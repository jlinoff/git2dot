...
# ================================================================
echo ""
Purpose="3 branches, squash, tags and branches, splines=polyline, @CHID@, tedge"
runcmd ../git2dot.py \
       $KeepOpt \
       -v \
       -v \
       -w 19 \
       --tedge "'[arrowhead=normal, dir=none, style=dotted, color=\"blue\"]'" \
